    ...
    namespace MG_State {
        ...
        namespace GLState {
            ...
            public:
                ...
                Uint64 GetBufferBindingPointGeneration(BufferTarget target) const {
                    return m_bufferState.GetBindPointGeneration(target);
                }
                void NoteBufferBindingPointChanged(BufferTarget target) {
                ...
                Uint64 GetTextureDrawSyncGeneration() const { return m_textureState.GetDrawSyncGeneration(); }
                void BumpTextureDrawSyncGeneration() { m_textureState.BumpDrawSyncGeneration(); }

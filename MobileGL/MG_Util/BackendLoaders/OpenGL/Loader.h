...
namespace MobileGL {
    namespace MG_External {
        ...
        struct GLESCapabilities {
            ...
            // Native block-compressed upload support.  GLES keeps S3TC optional and
            // some Android drivers expose only the split DXT1/DXT3/DXT5 extensions,
            // so track the formats independently instead of treating a non-null
            // glCompressedTexImage2D pointer as proof of support.
            Bool SupportsS3tcDxt1 = false;
            Bool SupportsS3tcDxt3 = false;
            Bool SupportsS3tcDxt5 = false;

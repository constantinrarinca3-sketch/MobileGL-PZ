    ...
    Bool FillInGLESCapabilities(MG_External::GLESCapabilities& caps, const MG_External::GLESFunctionsTable& glesFuncs) {
        ...
        for (GLint i = 0; i < extCount; ++i) {
            ...
            if (extension) {
                ...
                if (std::strcmp(extension, "GL_EXT_texture_compression_s3tc") == 0 ||
                    std::strcmp(extension, "GL_NV_texture_compression_s3tc") == 0) {
                    caps.SupportsS3tcDxt1 = true;
                    caps.SupportsS3tcDxt3 = true;
                    caps.SupportsS3tcDxt5 = true;
                }
                if (std::strcmp(extension, "GL_EXT_texture_compression_dxt1") == 0) {
                    caps.SupportsS3tcDxt1 = true;
                }
                if (std::strcmp(extension, "GL_ANGLE_texture_compression_dxt3") == 0) {
                    caps.SupportsS3tcDxt3 = true;
                }
                if (std::strcmp(extension, "GL_ANGLE_texture_compression_dxt5") == 0) {
                    caps.SupportsS3tcDxt5 = true;
                }

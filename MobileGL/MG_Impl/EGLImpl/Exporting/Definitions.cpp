...
#include <Includes.h>
#include "../EGLImpl.h"
#ifdef MOBILEGL_PZCOMPAT_LWJGL_THREAD_BRIDGE
#include <MG_Util/Debug/LwjglThreadBridge.h>
#endif
...
#ifdef MOBILEGL_PZCOMPAT_LWJGL_THREAD_BRIDGE
    MobileGL::MG_Util::Debug::LwjglThreadBridge::ObserveCurrentThread("eglMakeCurrent");
#endif
...
#ifdef MOBILEGL_PZCOMPAT_LWJGL_THREAD_BRIDGE
    MobileGL::MG_Util::Debug::LwjglThreadBridge::ObserveCurrentThread("eglSwapInterval");
#endif
...
#ifdef MOBILEGL_PZCOMPAT_LWJGL_THREAD_BRIDGE
    MobileGL::MG_Util::Debug::LwjglThreadBridge::ObserveCurrentThread("eglSwapBuffers");
#endif
#ifdef TRACY_ENABLE
    FrameMark;
#endif

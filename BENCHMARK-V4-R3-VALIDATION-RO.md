...
R3 acceptă schema nativă OPT-LAB V3 și atribuie toate metricile
`draw_prepare_*` numai lui 018. Self-testul verifică explicit această atribuire.
Benchmarkul jocului rămâne separat de cronometrele native: 018 nu se activează
într-o rulare folosită pentru verdict FPS.
